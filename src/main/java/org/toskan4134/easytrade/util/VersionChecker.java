...
public class VersionChecker {
    ...
    private static final String GITHUB_API_URL = "https://api.github.com/repos/Toskan4134/EasyTrade/releases/latest";
    ...
    private String fetchUrl(String urlString) throws Exception {
        ...
        connection.setRequestProperty("User-Agent", "EasyTrade/" + currentVersion);
    ...
    public String getConsoleMessage() {
        ...
        msg.append("====================================================\n");
        msg.append("  EasyTrade Update Available!\n");
        ...
        msg.append("  GitHub: https://github.com/Toskan4134/EasyTrade/releases\n");
        msg.append("  CurseForge: https://www.curseforge.com/hytale/mods/easytrade\n");
        msg.append("====================================================");
    ...
    public String getPlayerMessage() {
        ...
        return "[EasyTrade] Update available! v" + currentVersion + " -> v" + latestVersion +
